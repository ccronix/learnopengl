...
void render_scene_callback()
{
    ...
    glm::mat4 transform = glm::mat4(
        sin(scale_value), 0., 0., 0.,
        0., sin(scale_value), 0., 0.,
        0., 0., sin(scale_value), 0.,
        0., 0., 0., 1.
    );
...
{
    glm::vec3 vertex_list[3];
    vertex_list[0] = glm::vec3(-0.5, -0.5, 0.);
    vertex_list[1] = glm::vec3(0.5, -0.5, 0.);
    vertex_list[2] = glm::vec3(0., 0.5, 0.);
